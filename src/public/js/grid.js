...
var Grid = function () {
    ...
    Preview.prototype = {
        create: function () {
            ...
            //this.$closePreview = $( '<span class="og-close"></span>' ); // KP EDIT ... no close button in image detail page
        ...
        open: function () {
            setTimeout($.proxy(function () {
                ...
                this.setHeights().then(function () {
                    ...
                    // KGP edit: turn of scroll temporarily
        ...
        positionPreview: function () {
            ...
            var scrollParents = scrollableParents($grid),
                ...
                console.log(scrollableParents($grid));
...
(function ($) {
    ...
    var createExpandableGrid = function (options, images) {
        ...
        $ul.appendTo(this); // KP Edit... to keep the elements of our container div around, like h1's and close buttons.
        reflow(this);
        $(lis).show();
